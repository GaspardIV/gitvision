...
<template>
  ...
  <footer>
    ...
    <p style="text-align: center; width: 100%">This page uses Google cookies for analytics. Learn more <a href="https://policies.google.com/technologies/cookies">here</a>.</p>
  </footer>
</template>
